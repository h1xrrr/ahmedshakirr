                            ...
                            <ul>
                                <li>
                                    <div className="list_inner">
                                        ...
                                        <span>Al-Baladiyat Baghdad, IQ</span>
                                    </div>
                                </li>
                                <li>
                                    <div className="list_inner">
                                        <i className="icon-mail-3"></i>
                                        <span><a href="#">ahmedshakirr@outlook.com</a></span>
                                    </div>
                                </li>
                                <li>
                                    <div className="list_inner">
                                        <i className="icon-mobile"></i>
                                        <span>+964 7825683468</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div className="map_wrap">
                                    <div className="map" id="ieatmaps">
                                        <iframe
                                            ...
                                            style={{ width: "100%" }}
                                            id="gmap_canvas"
                                            src="https://maps.google.com/maps?q=Martyr%20Monument&t=k&z=17&ie=UTF8&iwloc=&output=embed"
                                        />
